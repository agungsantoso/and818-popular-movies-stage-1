...
public class Movie implements Parcelable {
     ...
     */
    public void originalTitleAs(String originalTitle) {
     ...
     */
    public void posterPathAs(String posterPath) {
     ...
     */
    public void overviewAs(String overview) {
     ...
     */
    public void voteAverageAs(Double voteAverage) {
     ...
     *                    null
     */
    public void releaseDateAs(String releaseDate) {
     ...
     * @return TMDb score
     */
    public String detailedVoteAverage() {
